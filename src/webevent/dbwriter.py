...
class DBWriter:
    ...
    def __init__(self, consumer: Consumer, db_host: str, db_port:int, db_user:str, db_name: str, table_name: str, event_type: type):
        ...
        self.connection = psycopg2.connect(f"host={db_host} port={db_port} user={db_user}")
